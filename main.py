...
import numpy as np
import os
from simulation import f as simulation
from doe_designs import doe_generate
from opt_fun_to_excel import calculate_opt_fun
import optimization_result

# Define the optimization range for each device
factors = [16, 61, 2, 15, 6, 45, 8, 51]  # PV_low, PV_high, BESS_low, BESS_high, rSOC_low, rSOC_high, HSS_low, HSS_high
doe_designs_file_name = 'designs_testing.xlsx'  # design file name to save the design matrix in xlsx file
...
# Final results - optimized system, in order to get the proper size round the numbers up
