...
output_sums_excel_path = 'sums_output_update_lower.xlsx'
...
optimization_file_path = 'designs_with_losses_fff_lower.xlsx'
...
if not csv_files:
    ...
    # print(F2)
    # print(F1)
    np.savetxt("doe_lower_2035.csv", dfs, delimiter=" ", header="PV Battery SOFC TANK energy_deficit Energy_loss System_cost F1 F2 LPSR")
